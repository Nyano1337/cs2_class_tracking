...
class CAK47 : CCSWeaponBaseGun { void* vtable[449]; };
...
class CBaseCSGrenade : CCSWeaponBase { void* vtable[453]; };
class CBaseCSGrenadeProjectile : CBaseGrenade { void* vtable[336]; };
...
class CBaseCombatCharacter : CBaseFlex { void* vtable[355]; };
...
class CBaseFlex : CBaseAnimGraph { void* vtable[320]; };
class CBaseFlexAlias_funCBaseFlex : CBaseFlex { void* vtable[320]; };
...
class CBaseGrenade : CBaseFlex, CDefaultPlayerPickupVPhysics { void* vtable[332]; };
...
class CBasePlayerPawn : CBaseCombatCharacter { void* vtable[417]; };
...
class CBasePlayerWeapon : CEconEntity { void* vtable[370]; };
class CBasePlayerWeaponVData : CEntitySubclassVDataBase { void* vtable[6]; };
class CBaseProp : CBaseAnimGraph { void* vtable[308]; };
class CBasePropDoor : CDynamicProp, CGameEventListener { void* vtable[343]; };
...
class CC4 : CCSWeaponBase { void* vtable[449]; };
...
class CCSGameRules : CTeamplayRules, IEntityListener { void* vtable[126]; };
...
class CCSObserverPawn : CCSPlayerPawnBase { void* vtable[430]; };
...
class CCSPlayerPawn : CCSPlayerPawnBase, IRenderBoundsWorldSpaceOverride { void* vtable[430]; };
...
class CCSPlayerPawnBase : CAI_ExpresserHost<CBasePlayerPawn> { void* vtable[430]; };
...
class CCSPointScriptEntity : CBaseEntity { void* vtable[241]; };
...
class CCSServerPointScriptEntity : CCSPointScriptEntity { void* vtable[241]; };
...
class CCSWeaponBase : CBasePlayerWeapon { void* vtable[447]; };
class CCSWeaponBaseGun : CCSWeaponBase { void* vtable[449]; };
...
class CChicken : CDynamicProp, CGameEventListener, CImprovLocomotor, IHasAttributes { void* vtable[317]; };
...
class CDEagle : CCSWeaponBaseGun { void* vtable[449]; };
...
class CDecoyGrenade : CBaseCSGrenade { void* vtable[453]; };
class CDecoyProjectile : CBaseCSGrenadeProjectile, CUtlAutoList<CDecoyProjectile> { void* vtable[336]; };
...
class CDynamicProp : CBreakableProp { void* vtable[315]; };
class CDynamicPropAlias_cable_dynamic : CDynamicProp { void* vtable[315]; };
class CDynamicPropAlias_dynamic_prop : CDynamicProp { void* vtable[315]; };
class CDynamicPropAlias_prop_dynamic_override : CDynamicProp { void* vtable[315]; };
...
class CEconEntity : CBaseFlex, IHasAttributes, IAttachmentOverride { void* vtable[329]; };
...
class CEconWearable : CEconEntity { void* vtable[340]; };
...
class CEnvCombinedLightProbeVolumeAlias_func_combined_light_probe_volume : CEnvCombinedLightProbeVolume { void* vtable[241]; };
class CEnvCubemap : CBaseEntity, CBaseCubemap { void* vtable[241]; };
class CEnvCubemapBox : CEnvCubemap { void* vtable[241]; };
...
class CEnvProjectedTexture : CModelPointEntity { void* vtable[269]; };
...
class CFlashbang : CBaseCSGrenade { void* vtable[453]; };
class CFlashbangProjectile : CBaseCSGrenadeProjectile { void* vtable[336]; };
...
class CHEGrenade : CBaseCSGrenade { void* vtable[453]; };
class CHEGrenadeProjectile : CBaseCSGrenadeProjectile { void* vtable[338]; };
...
class CHitboxSystem {};
class CHostage : CAI_ExpresserHost<CHostageExpresserShim>, CImprovLocomotor { void* vtable[362]; };
...
class CHostageAlias_info_hostage_spawn : CHostage { void* vtable[362]; };
class CHostageCarriableProp : CBaseAnimGraph { void* vtable[306]; };
class CHostageExpresserShim : CBaseCombatCharacter { void* vtable[355]; };
...
class CIncendiaryGrenade : CMolotovGrenade { void* vtable[453]; };
class CInferno : CBaseModelEntity, CGameEventListener { void* vtable[278]; };
...
class CInfoProjectedDecal : CPointEntity { void* vtable[241]; };
...
class CInstancedSceneEntity : CSceneEntity { void* vtable[294]; };
...
class CItemAssaultSuit : CItem { void* vtable[314]; };
class CItemDataCache {};
class CItemDefuser : CItem { void* vtable[314]; };
class CItemDefuserAlias_item_defuser : CItemDefuser { void* vtable[314]; };
class CItemDogtags : CItem { void* vtable[315]; };
class CItemGeneration : CAutoGameSystem { void* vtable[60]; };
class CItemGeneric : CItem { void* vtable[316]; };
class CItemGenericTriggerHelper : CBaseModelEntity { void* vtable[269]; };
class CItemKevlar : CItem { void* vtable[314]; };
...
class CItem_Healthshot : CWeaponBaseItem { void* vtable[452]; };
...
class CKnife : CCSWeaponBase { void* vtable[448]; };
...
class CMarkupVolumeTagged_NavGame : CMarkupVolumeWithRef { void* vtable[274]; };
...
class CMolotovGrenade : CBaseCSGrenade { void* vtable[453]; };
class CMolotovProjectile : CBaseCSGrenadeProjectile { void* vtable[336]; };
...
class COrnamentProp : CDynamicProp { void* vtable[315]; };
...
class CPathMover : CPathSimple { void* vtable[243]; };
...
class CPathParticleRopeAlias_path_particle_rope_clientside : CPathParticleRope { void* vtable[241]; };
...
class CPhysBox : CBreakable { void* vtable[270]; };
...
class CPhysHingeAlias_phys_hinge_local : CPhysHinge { void* vtable[244]; };
...
class CPhysicsProp : CBreakableProp, INavObstacle { void* vtable[315]; };
class CPhysicsPropMultiplayer : CPhysicsProp { void* vtable[315]; };
class CPhysicsPropOverride : CPhysicsProp { void* vtable[315]; };
class CPhysicsPropRespawnable : CPhysicsProp { void* vtable[315]; };
...
class CPropDoorRotating : CBasePropDoor { void* vtable[347]; };
class CPropDoorRotatingBreakable : CPropDoorRotating { void* vtable[347]; };
...
class CPushable : CBreakable { void* vtable[270]; };
...
class CRagdollProp : CBaseAnimGraph, CDefaultPlayerPickupVPhysics { void* vtable[309]; };
class CRagdollPropAlias_physics_prop_ragdoll : CRagdollProp { void* vtable[309]; };
class CRagdollPropAttached : CRagdollProp { void* vtable[309]; };
...
class CRopeKeyframeAlias_move_rope : CRopeKeyframe { void* vtable[270]; };
class CRotButton : CBaseButton { void* vtable[279]; };
class CRotDoor : CBaseDoor { void* vtable[272]; };
...
class CSceneEntityAlias_logic_choreographed_scene : CSceneEntity { void* vtable[291]; };
...
class CScriptItem : CItem { void* vtable[314]; };
class CScriptNavBlocker : CFuncNavBlocker { void* vtable[269]; };
...
class CShatterGlassShardPhysics : CPhysicsProp { void* vtable[315]; };
...
class CSmokeGrenade : CBaseCSGrenade { void* vtable[453]; };
class CSmokeGrenadeProjectile : CBaseCSGrenadeProjectile, CGameEventListener, CUtlAutoList<CSmokeGrenadeProjectile> { void* vtable[336]; };
...
class CWeaponAWP : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponAug : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponBaseItem : CCSWeaponBase { void* vtable[452]; };
class CWeaponBaseItem::NetworkVar_m_SequenceCompleteTimer : CountdownTimer { void* vtable[4]; };
class CWeaponBizon : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponCZ75a : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponEconData : CItemDataCache { void* vtable[1]; };
class CWeaponElite : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponFamas : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponFiveSeven : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponG3SG1 : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponGalilAR : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponGlock : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponHKP2000 : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponM249 : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponM4A1 : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponM4A1Silencer : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponMAC10 : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponMP5SD : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponMP7 : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponMP9 : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponMag7 : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponNOVA : CCSWeaponBase { void* vtable[447]; };
class CWeaponNegev : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponP250 : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponP90 : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponRevolver : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponSCAR20 : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponSG556 : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponSSG08 : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponSawedoff : CCSWeaponBase { void* vtable[447]; };
class CWeaponTaser : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponTec9 : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponUMP45 : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponUSPSilencer : CCSWeaponBaseGun { void* vtable[449]; };
class CWeaponXM1014 : CCSWeaponBase { void* vtable[447]; };
