...
class CBasePlayerPawn : CBaseCombatCharacter { void* vtable[393]; };
...
class CCSObserverPawn : CCSPlayerPawnBase { void* vtable[407]; };
...
class CCSPlayerPawn : CCSPlayerPawnBase, IRenderBoundsWorldSpaceOverride { void* vtable[407]; };
...
class CCSPlayerPawnBase : CAI_ExpresserHost<CBasePlayerPawn>, IHasAttributes { void* vtable[407]; };
...
class CEnvSoundscape : CBaseEntity { void* vtable[228]; };
