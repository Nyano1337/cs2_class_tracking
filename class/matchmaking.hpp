...
class CFastSteamFriendsWithInProcessCache::CacheableMap<bool,bool,class CFastSteamFriendsWithInProcessCache> : CFastSteamFriendsWithInProcessCache::ICacheableMapEvictable { void* vtable[1]; };
class CFastSteamFriendsWithInProcessCache::CacheableMap<char const * __ptr64,class CUtlString,class ISteamFriends> : CFastSteamFriendsWithInProcessCache::ICacheableMapEvictable { void* vtable[1]; };
class CFastSteamFriendsWithInProcessCache::CacheableMap<enum EFriendRelationship,enum EFriendRelationship,class ISteamFriends> : CFastSteamFriendsWithInProcessCache::ICacheableMapEvictable { void* vtable[1]; };
class CFastSteamFriendsWithInProcessCache::CacheableMap<enum EPersonaState,enum EPersonaState,class ISteamFriends> : CFastSteamFriendsWithInProcessCache::ICacheableMapEvictable { void* vtable[1]; };
class CFastSteamFriendsWithInProcessCache::CacheableMap<int,int,class ISteamFriends> : CFastSteamFriendsWithInProcessCache::ICacheableMapEvictable { void* vtable[1]; };
class CFastSteamFriendsWithInProcessCache::CacheableMapXParams<char const * __ptr64,class CUtlString,char const * __ptr64,class CUtlString,class ISteamFriends> : CFastSteamFriendsWithInProcessCache::ICacheableMapEvictable { void* vtable[1]; };
class CFastSteamFriendsWithInProcessCache::CacheableMapXParams<char const * __ptr64,class CUtlString,int,int,class ISteamFriends> : CFastSteamFriendsWithInProcessCache::ICacheableMapEvictable { void* vtable[1]; };
