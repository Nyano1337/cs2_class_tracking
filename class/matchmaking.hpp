...
class CMatchSystem : IMatchSystem { void* vtable[2]; };
...
class CMatchTitleGameSettingsMgr : IMatchTitleGameSettingsMgr { void* vtable[21]; };
...
class CSysSessionBase { void* vtable[10]; };
class CSysSessionClient : CSysSessionBase { void* vtable[10]; };
class CSysSessionHost : CSysSessionBase { void* vtable[10]; };
class CSysSessionStubForTeamSearch<class CSysSessionClient> : CSysSessionClient { void* vtable[11]; };
class CSysSessionStubForTeamSearch<class CSysSessionHost> : CSysSessionHost { void* vtable[11]; };
class CThread {};
...
class GameTypes : CGameAppSystem<IGameTypes,0> { void* vtable[78]; };
class IAppSystem {};
class IGameEventListener2 { void* vtable[2]; };
class IGameTypes : IAppSystem { void* vtable[78]; };
