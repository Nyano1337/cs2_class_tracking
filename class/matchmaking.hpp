...
class CCallback<PlayerManager,FriendRichPresenceUpdate_t,0> : CCallbackImpl<12> { void* vtable[4]; };
...
class CFastSteamFriendsWithInProcessCache::CacheableMapXParams<char const * __ptr64,CUtlString,char const * __ptr64,CUtlString,ISteamFriends> : CFastSteamFriendsWithInProcessCache::ICacheableMapEvictable { void* vtable[1]; };
class CFastSteamFriendsWithInProcessCache::CacheableMapXParams<char const * __ptr64,CUtlString,int,int,ISteamFriends> : CFastSteamFriendsWithInProcessCache::ICacheableMapEvictable { void* vtable[1]; };
