...
class CHLTVClientState : CNetworkGameClientBase { void* vtable[137]; };
...
class CNetworkGameClient : CNetworkGameClientBase, ISwitchLoopModeStatusNotify { void* vtable[137]; };
class CNetworkGameClientBase : INetworkGameClient, CUtlSlot, INetworkMessageProcessingPreFilter, IConnectionlessPacketHandler, INetworkChannelNotify, IGameEventWatcher { void* vtable[137]; };
