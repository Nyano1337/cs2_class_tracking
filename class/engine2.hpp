...
class CBaseEngineService<IInputService> : CTier4AppSystem<IInputService,0> { void* vtable[60]; };
class CBaseEngineService<IMapListService> : CTier4AppSystem<IMapListService,0> { void* vtable[26]; };
class CBaseEngineService<INetworkClientService> : CTier4AppSystem<INetworkClientService,0> { void* vtable[63]; };
...
class CBaseEngineService<IToolService> : CTier4AppSystem<IToolService,0> { void* vtable[91]; };
...
class CCompressedResourceManifestRefCounted : CRefCounted1<CCompressedResourceManifest,CRefCountServiceBase<CRefMT> > { void* vtable[1]; };
...
class CDemoMessagePB<18,CDemoRecovery> : IDemoMessage, CDemoRecovery { void* vtable[6]; };
...
class CHLTVClientState : CNetworkGameClientBase { void* vtable[141]; };
class CHLTVDemoRecorder : IDemoRecorder { void* vtable[22]; };
class CHLTVFrame : CClientFrame { void* vtable[2]; };
class CHLTVServer : CNetworkGameServerBase, IHLTVServer, ITvStreamSink { void* vtable[77]; };
...
class CNetworkGameClient : CNetworkGameClientBase, ISwitchLoopModeStatusNotify { void* vtable[141]; };
...
class CNetworkGameServer : CNetworkGameServerBase { void* vtable[77]; };
...
class CRefCounted1<CCompressedResourceManifest,CRefCountServiceBase<CRefMT> > : CCompressedResourceManifest, CRefCountServiceBase<CRefMT> {};
