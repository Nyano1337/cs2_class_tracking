...
class CEngineClient : CTier4AppSystem<IVEngineClient2,0> { void* vtable[189]; };
...
class CHLTVClientState : CNetworkGameClientBase { void* vtable[136]; };
...
class CNetworkGameClient : CNetworkGameClientBase, ISwitchLoopModeStatusNotify { void* vtable[136]; };
class CNetworkGameClientBase : INetworkGameClient, CUtlSlot, INetworkMessageProcessingPreFilter, IConnectionlessPacketHandler, INetworkChannelNotify, IGameEventWatcher { void* vtable[136]; };
