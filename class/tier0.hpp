...
class CGlobalThreadPool : CThreadPool { void* vtable[22]; };
...
class CMemPassAllocT<LLA_AddAlignedSelectors<LowLevelAllocationScheme_mimalloc> > : IMemAlloc_Internal {};
...
class CThreadPool : CRefCounted1<IThreadPool,CRefCountServiceBase<CRefMT> > { void* vtable[22]; };
...
class CUtlReportPrinter::IReportOutput {};
