...
class CCvar : CTier0AppSystem<ICvar,0> { void* vtable[46]; };
...
class CDirTreeWatchManager::Visitor {};
...
class CUtlStringTokenSystem : CTier0AppSystem<IUtlStringTokenSystem,0> { void* vtable[12]; };
class CVBinaryModule { void* vtable[4]; };
class CVBreakpadSymbolModule : CVSymbolModule { void* vtable[21]; };
class CVDbgHelpSymbolModule : CVSymbolModule { void* vtable[21]; };
class CVDwarfBinaryModule : CVBinaryModule { void* vtable[4]; };
class CVDwarfSymbolModule : CVSymbolModule { void* vtable[21]; };
...
struct EnumerateAbsPathsInDirRecursiveVisitor_t : CDirTreeWatchManager::Visitor { void* vtable[5]; };
