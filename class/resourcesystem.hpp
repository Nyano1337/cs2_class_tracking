...
class CNullTypeManager : IResourceTypeManager { void* vtable[22]; };
...
class CResourceManifestTypeManager : IResourceTypeManager { void* vtable[22]; };
...
class CTestResourceTypeManager : CDefaultKV3TransferResourceTypeManager<500152235126> { void* vtable[26]; };
...
class CVDataTypeManager : CKV3ResourceTypeManager<418564367478>, IVDataTypeManager { void* vtable[26]; };
