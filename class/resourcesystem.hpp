...
class CNullTypeManager : IResourceTypeManager { void* vtable[24]; };
class CPostConnectCallback { void* vtable[1]; };
class CRD_AsyncProcessDataUtils : IRD_AsyncProcessDataUtils { void* vtable[2]; };
...
class CResourceManifestTypeManager : IResourceTypeManager { void* vtable[24]; };
...
class CResourceSystem : IResourceHandleUtils { void* vtable[11]; };
...
class CTestResourceTypeManager : CDefaultKV3TransferResourceTypeManager<500152235126> { void* vtable[28]; };
...
class CVDataTypeManager : CKV3ResourceTypeManager<418564367478>, IVDataTypeManager { void* vtable[28]; };
...
class IRD_AsyncProcessDataUtils : IRD_ResourceExtrefUtils {};
