class CBaseAppSystem<class INetworkSystem> : INetworkSystem {};
...
class CCLCMsg_RconServerDetails_t : CCLCMsg_RconServerDetails { void* vtable[17]; };
class CCLCMsg_RconServerDetails_t : CNetMessagePB<35,CCLCMsg_RconServerDetails,0,1,0>, CCLCMsg_RconServerDetails { void* vtable[5]; };
...
class CConCommandMemberAccessor<class CFlattenedSerializers> : ConCommand, ICommandCallback, ICommandCompletionCallback { void* vtable[1]; };
class CConCommandMemberAccessor<class CFlattenedSerializers> : ICommandCompletionCallback { void* vtable[1]; };
class CConCommandMemberAccessor<class CNetworkMessages> : ConCommand, ICommandCallback, ICommandCompletionCallback { void* vtable[1]; };
class CConCommandMemberAccessor<class CNetworkMessages> : ICommandCompletionCallback { void* vtable[1]; };
...
class CFlattenedSerializers : IFlattenedSerializers { void* vtable[45]; };
...
class CNETMsg_SplitScreenUser_t : CNETMsg_SplitScreenUser { void* vtable[17]; };
class CNETMsg_SplitScreenUser_t : CNetMessagePB<3,CNETMsg_SplitScreenUser,11,1,0>, CNETMsg_SplitScreenUser { void* vtable[5]; };
class CNETMsg_StringCmd : google::protobuf::Message { void* vtable[17]; };
class CNETMsg_Tick : google::protobuf::Message { void* vtable[17]; };
class CNetChan : INetChannel, CUtlSlot { void* vtable[87]; };
...
class CNetMessagePB<0,class CNETMsg_NOP,11,1,0> : CNETMsg_NOP { void* vtable[17]; };
class CNetMessagePB<0,class CNETMsg_NOP,11,1,0> : CNetMessage, CNETMsg_NOP { void* vtable[5]; };
class CNetMessagePB<0,class CNETMsg_NOP,11,1,0>::CProtobufBinding : IProtobufBinding { void* vtable[9]; };
...
class CNetMessagePB<3,class CNETMsg_SplitScreenUser,11,1,0> : CNETMsg_SplitScreenUser { void* vtable[17]; };
class CNetMessagePB<3,class CNETMsg_SplitScreenUser,11,1,0> : CNetMessage, CNETMsg_SplitScreenUser { void* vtable[5]; };
class CNetMessagePB<3,class CNETMsg_SplitScreenUser,11,1,0>::CProtobufBinding : IProtobufBinding { void* vtable[9]; };
...
class CNetworkMessages : INetworkMessages { void* vtable[37]; };
...
class CNetworkSystem : IVConCommDataReceived { void* vtable[1]; };
...
class INetChannel : INetChannelInfo { void* vtable[87]; };
...
class NetMessageConnectionClosed_t : NetMessageConnectionClosed { void* vtable[17]; };
class NetMessageConnectionClosed_t : CNetMessagePB<-1,NetMessageConnectionClosed,11,1,0>, NetMessageConnectionClosed { void* vtable[5]; };
class NetMessageConnectionCrashed : google::protobuf::Message { void* vtable[17]; };
class NetMessageConnectionCrashed_t : NetMessageConnectionCrashed { void* vtable[17]; };
class NetMessageConnectionCrashed_t : CNetMessagePB<-1,NetMessageConnectionCrashed,11,1,0>, NetMessageConnectionCrashed { void* vtable[5]; };
class NetMessagePacketEnd : google::protobuf::internal::ZeroFieldsBase { void* vtable[17]; };
class NetMessagePacketEnd_t : NetMessagePacketEnd { void* vtable[17]; };
class NetMessagePacketEnd_t : CNetMessagePB<1073741825,NetMessagePacketEnd,11,1,0>, NetMessagePacketEnd { void* vtable[5]; };
class NetMessagePacketStart : google::protobuf::internal::ZeroFieldsBase { void* vtable[17]; };
class NetMessagePacketStart_t : NetMessagePacketStart { void* vtable[17]; };
class NetMessagePacketStart_t : CNetMessagePB<1073741824,NetMessagePacketStart,11,1,0>, NetMessagePacketStart { void* vtable[5]; };
class NetMessageSplitscreenUserChanged : google::protobuf::Message { void* vtable[17]; };
class NetMessageSplitscreenUserChanged_t : NetMessageSplitscreenUserChanged { void* vtable[17]; };
class NetMessageSplitscreenUserChanged_t : CNetMessagePB<-1,NetMessageSplitscreenUserChanged,11,1,0>, NetMessageSplitscreenUserChanged { void* vtable[5]; };
