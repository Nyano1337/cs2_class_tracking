...
class CCLCMsg_ClientInfo : google::protobuf::Message { void* vtable[23]; }
...
class CCLCMsg_RconServerDetails : google::protobuf::Message { void* vtable[19]; }
...
class CCLCMsg_RespondCvarValue : google::protobuf::Message { void* vtable[21]; }
class CCLCMsg_ServerStatus : google::protobuf::Message { void* vtable[21]; }
...
class CCLCMsg_VoiceData : google::protobuf::Message { void* vtable[27]; }
...
class CMsgSource2SystemSpecs : google::protobuf::Message { void* vtable[21]; }
...
class CMsgVoiceAudio : google::protobuf::Message { void* vtable[19]; }
...
class CSVCMsg_Broadcast_Command : google::protobuf::Message { void* vtable[21]; }
...
class CSVCMsg_HLTVStatus : google::protobuf::Message { void* vtable[23]; }
...
class CSVCMsg_PacketEntities_alternate_baseline_t : google::protobuf::Message { void* vtable[25]; }
class CSVCMsg_PacketEntities_non_transmitted_entities_t : google::protobuf::Message { void* vtable[19]; }
class CSVCMsg_PacketReliable : google::protobuf::Message { void* vtable[17]; }
class CSVCMsg_PeerList : google::protobuf::Message { void* vtable[21]; }
class CSVCMsg_Prefetch : google::protobuf::Message { void* vtable[27]; }
class CSVCMsg_Print : google::protobuf::Message { void* vtable[19]; }
class CSVCMsg_RconServerDetails : google::protobuf::Message { void* vtable[19]; }
...
class CSVCMsg_ServerInfo : google::protobuf::Message { void* vtable[23]; }
...
class CSVCMsg_UpdateStringTable : google::protobuf::Message { void* vtable[23]; }
class CSVCMsg_UserCommands : google::protobuf::Message { void* vtable[19]; }
...
class NetMessageSplitscreenUserChanged : google::protobuf::Message { void* vtable[19]; }
...
class ProtoFlattenedSerializer_t : google::protobuf::Message { void* vtable[35]; }
